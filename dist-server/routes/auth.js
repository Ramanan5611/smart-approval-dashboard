...
var generateToken = function (userId) {
    return jsonwebtoken_1.default.sign({ userId: userId }, process.env.JWT_SECRET, { expiresIn: '24h' });
};
// Login route
router.post('/login', loginLimiter, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
router.post('/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, role, name_1, passwordCheck, existingUser, user, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
